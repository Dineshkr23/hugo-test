...
window.location.pathname.includes("casestudies")
  ? (page = "casestudies")
  : false;
window.location.pathname.includes("services") ? (page = "services") : false;

nav.querySelector(".active").classList.remove("active");
nav.querySelector(`.nav-${page}`).classList.add("active");

// document.querySelector('.no-default').addEventListener("click", function (event) {
